...
`apigeecli products create --approval auto --display-name NAME --envs ENV --interval INTERVAL --name NAME --opgrp FILE --org ORG --quota QUOTA --token TOKEN --unit hour`

`apigeecli products create --approval auto --display-name NAME --envs ENV --interval INTERVAL --name NAME --opgrp FILE --org ORG --quota QUOTA --token TOKEN --unit minute`

`apigeecli products create --approval auto --display-name NAME --envs ENV --opgrp FILE --org ORG --scopes SCOPES --scopes SCOPES --token TOKEN`

`apigeecli products create --approval auto --display-name NAME --envs ENV --opgrp FILE --org ORG --scopes SCOPES --token TOKEN`

`apigeecli products create --approval auto --display-name NAME --envs ENV --opgrp FILE --org ORG --token TOKEN`

`apigeecli products create --name NAME --display-name ... --proxies ... --approval-type ... --org ORGNAME --token TOKEN`

`apigeecli products create --name NAME --display-name ... --proxies ... --envs ... --approval-type ... --org ORGNAME --token TOKEN`

`apigeecli products create --name NAME --display-name ... --proxies ... --scopes ... --attrs ... --approval ... --org ORGNAME --token TOKEN`
...
`apigeecli resources create --org ORGNAME" --env ENVNAME --token TOKEN --name NAME_OF_RESOURCE --type {properties|js|py|xsd|wsdl..} --respath /path/to/resource-filename`
